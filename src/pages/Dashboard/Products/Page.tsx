...
import { useGetPrivateProductsQuery } from "../../../services/products.service";
...
const ProductsDashboard: React.FC = () => {
  ...
  const handleFilterChange = (newFilterParams: Partial<typeof filterParams>) => {
    setCurrentPage(1);
    setFilterParams({ ...filterParams, ...newFilterParams });
  };

  const { data, isFetching, isLoading, isError } = useGetPrivateProductsQuery({ ...filterParams, page: currentPage.toString() });
